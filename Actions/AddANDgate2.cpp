...
/* Constructor */
AddANDgate2::AddANDgate2(ApplicationManager* pAppMan, ActionType actType, Data* pLoadedData) : Action(pAppMan) {
	mActType = actType;
	mGate = NULL;
	mIsLoaded = false;
...
string AddANDgate2::GetActionMsg() {
	switch (mActType)
	{
...
void AddANDgate2::CalculateDimensions() {
	int w, h;
